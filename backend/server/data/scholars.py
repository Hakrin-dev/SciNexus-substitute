"""学者 mock 数据 —— 内容对齐前端 lib/data/scholars.ts（数据字段，视觉字段由前端派生）。"""
...
SCHOLAR_DIRECTIONS = [
    {"name": "机器学习", "count": "2.1k"},
    {"name": "计算机视觉", "count": "1.5k"},
    {"name": "自然语言处理", "count": "1.2k"},
    {"name": "强化学习", "count": "624"},
    {"name": "机器人学", "count": "412"},
]

# 学者详情（何恺明）—— 与前端 scholarDetail 一致
SCHOLAR_DETAILS = {
    "kaiming-he": {
        "id": "kaiming-he",
        "location": "美国 · 马萨诸塞州剑桥",
        ...
        "publications": [
            ...
            },
            {
                ...
                "abstract": "MeanFlow (MF) has recently been established as a framework for one-step generative modeling. However, its fastforward nature introduces key challenges in both the training objective and the guidance mechanism. …",
